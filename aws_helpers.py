...
def get_file_content(file_name: str, agent_id: int, agent_execution_id: int):
    """
    ...
    final_path = ResourceHelper.get_agent_read_resource_path(file_name, agent=Agent.get_agent_from_id(
        session=None, agent_id=agent_id), agent_execution=AgentExecution
                                                             .get_agent_execution_from_id(session=None,
...
def add_file_to_resources(self, file_name, session):
